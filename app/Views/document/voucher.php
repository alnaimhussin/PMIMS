...
<div class="content-wrapper" style="height:100%; padding-bottom:60px">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Document Tracking - Voucher List</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-10 col-sm-12">
            <div class="row pl-2 pr-2">
                <span class="input-group-text col-lg-2 col-sm-12 bg-light text-dark">Voucher Type</span>
            ...
            <div class="row pl-2 pr-2 mt-1">
                <span class="input-group-text col-lg-2 col-sm-12 bg-light text-dark">Voucher ID</span>
