...
<div class="content-wrapper" style="height:100%; padding-bottom:60px">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Document Tracking - Outgoing List</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">Home</li>
            <li class="breadcrumb-item">Document Tracking</li>
            <li class="breadcrumb-item active">Outgoing List</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid">
      <div class="col-12">
        <div class="row pl-2 pr-2 mt-2 mb-2">
            <button type="button" class="col-lg-2 col-sm-12 btn btn-dark mr-1" data-toggle="modal" data-target="#modal-add">Release Documents</button>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-10 col-sm-12">
            <div class="row pl-2 pr-2">
                <span class="input-group-text col-lg-2 col-sm-12 bg-light text-dark">Document Type</span>
            ...
            <div class="row pl-2 pr-2 mt-1">
                <span class="input-group-text col-lg-2 col-sm-12 bg-light text-dark">Document ID</span>
        ...
        <div class="col-12">
          <div class="card card-dark text-dark">
            <div class=" bg-dark bg-gradient text-white pl-2 pt-2" style="height: 2.6rem;">
                <div class="card-icon">
                  <span class=""><i class="nav-icon fas fa-file-export"></i></span>
                </div>
              <h5 class="">Outgoing List</h5>
            </div>
                ...
                <table id="employee_table" class="table table-bordered  table-striped table-head-fixed table-hover text-wrap">
                  <thead style="text-align: center; vertical-align: middle">
                    <tr style="line-height: 20px">
                      ...
                      <th class="align-middle" style="width:5%">Document ID</th>
                      <th class="align-middle" style="width:5%">Document Type</th>
                      ...
                      <th class="align-middle" style="width:3%">Date Released</th>
                      <th class="align-middle" style="width:5%">Released By</th>
