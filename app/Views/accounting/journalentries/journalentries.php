                ...
                <table id="employee_table" class="table table-bordered  table-striped table-head-fixed table-hover text-wrap">
                  <thead style="text-align: center; vertical-align: middle">
                    <tr style="line-height: 20px">
                      ...
                      <th class="align-middle" style="width:10%">Entry Date</th>
                      <th class="align-middle" style="">Description</th>
                      <th class="align-middle" style="width:20%">Entry Ref. #</th>
                      <th class="align-middle" style="width:10%">Total Debit</th>
                      <th class="align-middle" style="width:10%">Total Creed</th>
                    </tr>
                  </thead>
                  <tbody id="search" name="search" style="font-size:12px">
                    <?php $n=1; if ($employee) : ?>
                    <?php foreach ($employee->getResult() as $post) : ?>
                    <tr style="line-height: 20px; font-size: 13px" ondblclick="viewDetail('<?php echo $post->_id; ?>')">
