        ...
        <div class="col-12">
          <div class="card card-dark text-dark">
            <div class=" bg-dark bg-gradient text-white pl-2 pt-2" style="height: 2.6rem;">
              ...
              <h5 class="">List of Bank Accounts</h5>
            </div>
                ...
                <table id="employee_table" class="table table-bordered  table-striped table-head-fixed table-hover text-wrap">
                  <thead style="text-align: center; vertical-align: middle">
                    <tr style="line-height: 20px">
                      ...
                      <th class="align-middle" style="width:10%">Bank Code</th>
                      <th class="align-middle">Bank Name</th>
                      <th class="align-middle">Account Name</th>
                      <th class="align-middle">Account #</th>
                      <th class="align-middle" style="width:10%">Date Creadted</th>
                    </tr>
                  </thead>
                  <tbody id="search" name="search" style="font-size:12px">
                    <?php $n=1; if ($bankaccount) : ?>
                    <?php foreach ($bankaccount->getResult() as $post) : ?>
                    <tr style="line-height: 20px" ondblclick="viewDetail('<?php echo $post->_id; ?>')">
                      <td class="pl-3"><?php echo $n ?></td>
                      <td><?php echo strtoupper($post->bank_code) ?></td>
                      <td><b><?php echo strtoupper($post->bank_name) ?></b></td>
                      <td><?php echo strtoupper($post->account_name) ?></td>
                      <td><?php echo strtoupper($post->account_number) ?></td>
