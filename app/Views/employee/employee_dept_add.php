...
<?php $sessionDept = session()->get('department'); ?>

<script>
    // 1. Pass the value securely to JavaScript
    const SESSION_DEPT_ID = "<?php echo $sessionDept ? esc($sessionDept) : ''; ?>";
    const ADMIN_DEPT_ID = '0'; // Define the admin ID for comparison
</script>
                        ...
                        <div class="row">
                          <div class="col-6" style="padding: 1px">
                            <div class="input-group mb-1 col-sm-12 col-lg-12">
                              <div class="input-group-prepend">
                                <span class="input-group-text text-danger" style="width: 120px">Lastname</span>
                              </div>
                            ...
                            <div class="input-group mb-1 col-sm-12 col-lg-12">
                              <div class="input-group-prepend">
                                <span class="input-group-text text-danger" style="width: 120px">Firstname</span>
                              </div>
                          ...
                          <div class="col-6" style="padding: 1px">
                            ...
                            <div class="input-group mb-1 col-sm-12 col-lg-12">
                              <div class="input-group-prepend">
                                <span class="input-group-text text-danger" style="width: 120px">Contact #</span>
                              </div>
