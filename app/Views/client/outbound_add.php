    ...
    <section class="content">
      ...
      <div class="card card-primary">
        ...
        <form id="myForm" class="form-horizontal" method="post" enctype="multipart/form-data"
          onSubmit="return checkform()" action="<?= base_url() ?>/clint/saveOutbound">
          <div class="card-body">
            <div class="box-body">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-lg-7">
                          <div class="input-group" id="medicalcert" <?php if ($posts) {
                                                                      if ($posts['category'] == "") {
                                                                        echo "hidden";
                                                                      }
                                                                    } ?>>
                          ...
                          <div class="input-group" id="travelauth" style="margin-top:10px;" <?php if ($posts) {
                                                                                              if ($posts['category'] == "") {
                                                                                                echo "hidden";
                                                                                              }
                                                                                            } ?>>
                          ...
                          <div class="input-group" id="residency" style="margin-top:10px;" <?php if ($posts) {
                                                                                              if ($posts['category'] == "3") {
                                                                                                echo "hidden";
                                                                                              }
                                                                                            } ?>>
                          ...
                          <div class="input-group" id="owwa" style="margin-top:10px;" <?php if ($posts) {
                                                                                        if ($posts['category'] != "2") {
                                                                                          echo "hidden";
                                                                                        }
                                                                                      } ?>>
                          ...
                          <div class="input-group" id="companyid" style="margin-top:10px;" <?php if ($posts) {
                                                                                              if ($posts['category'] != "3") {
                                                                                                echo "hidden";
                                                                                              }
                                                                                            } ?>>
                          ...
                          <div class="input-group" id="employmentcert" style="margin-top:10px;" <?php if ($posts) {
                                                                                                  if ($posts['category'] != "3") {
                                                                                                    echo "hidden";
                                                                                                  }
                                                                                                } ?>>
                          ...
                          <div class="input-group" id="travelorder" style="margin-top:10px;" <?php if ($posts) {
                                                                                                if ($posts['category'] != "3") {
                                                                                                  echo "hidden";
                                                                                                }
                                                                                              } ?>>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-4">
                  <select class="form-control" id="province" name="province" onchange="getRefCityMun()">
                    ...
                    <option value="<?php echo $post->provCode; ?>" <?php if ($posts) {
                                                                          if ($posts['province'] == $post->provCode) {
                                                                            echo "selected";
                                                                          }
                                                                        } ?>>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-4">
                  <select class="form-control" id="lgu" name="lgu" onchange="getBarangay()">
                    ...
                    <option value="<?php echo $post->lguCode; ?>" <?php if ($posts) {
                                                                        if ($posts['lgu'] == $post->lguCode) {
                                                                          echo "selected";
                                                                        }
                                                                      } ?>>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-3">
                  <input type="text" class="form-control" id="contactname" name="contactname" placeholder="Contact Name"
                    value="<?php if ($posts) {
                                                                                                                                  echo $posts['contactname'];
                                                                                                                                } ?>">
                </div>
                <div class="col-sm-6 col-lg-2">
                  <select class="form-control" id="contactrelation" name="contactrelation">
                    <option value="">Relationship</option>
                    <option value="Husband" <?php if ($posts) {
                                              if ($posts['contactrelation'] == "Husband") {
                                                echo "selected";
                                              }
                                            } ?>>Husband
                    </option>
                    <option value="Wife" <?php if ($posts) {
                                            if ($posts['contactrelation'] == "Wife") {
                                              echo "selected";
                                            }
                                          } ?>>Wife
                    </option>
                    <option value="Father" <?php if ($posts) {
                                              if ($posts['contactrelation'] == "Father") {
                                                echo "selected";
                                              }
                                            } ?>>Father
                    </option>
                    <option value="Mother" <?php if ($posts) {
                                              if ($posts['contactrelation'] == "Mother") {
                                                echo "selected";
                                              }
                                            } ?>>Mother
                    </option>
                    <option value="Brother" <?php if ($posts) {
                                              if ($posts['contactrelation'] == "Brother") {
                                                echo "selected";
                                              }
                                            } ?>>Brother
                    </option>
                    <option value="Sister" <?php if ($posts) {
                                              if ($posts['contactrelation'] == "Sister") {
                                                echo "selected";
                                              }
                                            } ?>>Sister
                    </option>
                    <option value="Son" <?php if ($posts) {
                                          if ($posts['contactrelation'] == "Son") {
                                            echo "selected";
                                          }
                                        } ?>>Son
                    </option>
                    <option value="Daughter" <?php if ($posts) {
                                                if ($posts['contactrelation'] == "Daughter") {
                                                  echo "selected";
                                                }
                                              } ?>>
                      Daughter</option>
                    <option value="Other" <?php if ($posts) {
                                            if ($posts['contactrelation'] == "Other") {
                                              echo "selected";
                                            }
                                          } ?>>Other
                    </option>
