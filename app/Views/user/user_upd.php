              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5 col-lg-2">
                  <input type="text" class="form-control" id="age" name="age" placeholder="Age"
                    value="<?php if ($post) { echo $post->age; } ?>">
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-5 col-lg-2">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="birthday" name="birthday"
                      ...
                      value="<?php if ($post) { echo $post->birthday; } ?>">
                  </div>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-5 col-lg-2">
                  <select class="form-control" id="gender" name="gender">
                    ...
                    <option <?php if ($post) { if ($post->gender == "Male") { echo "selected"; } } ?>>Male</option>
                    <option <?php if ($post) { if ($post->gender == "Female") { echo "selected"; } } ?>>Female
                    </option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-5 col-lg-2">
                  <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile"
                    ...
                    value="<?php if ($post) { echo $post->mobile; } ?>">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-4">
                  <select class="form-control" id="category" name="category" onchange="disable(this.value)">
                    ...
                    <option value="1" <?php if ($post) { if ($post->category == "1") { echo "selected"; } } ?>>
                      MEDICAL FRONTLINER</option>
                    <option value="2" <?php if ($post) { if ($post->category == "2") { echo "selected"; } } ?>>
                      ESSENTIAL / APOR / GOV'T EMPLOYEE / PUBLIC SERVANT</option>
                    <option value="3" <?php if ($post) { if ($post->category == "3") { echo "selected"; } } ?>>
                      BUSINESS PURPOSE</option>
                    <option value="4" <?php if ($post) { if ($post->category == "4") { echo "selected"; } } ?>>
                      PATIENT & WATCHER</option>
                  </select>
                </div>
              </div>
              <div class="form-group row" id="requirements"
                <?php if (!$post) { echo "hidden"; } else { if ($post->category == "") { echo "hidden"; } } ?>>
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        <div class="col-sm-12 col-lg-5">
                          <div id="fr"
                            <?php if (!$post) { echo "hidden"; } else { if ($post->category != "1") { echo "hidden"; } } ?>>
                            <div class="card card-primary">
                              <div class="card-body">
                                - Frontliner ID <br>
                          ...
                          <div id="govt"
                            <?php if (!$post) { echo "hidden"; } else { if ($post->category != "2") { echo "hidden"; } } ?>>
                            <div class="card card-primary">
                              <div class="card-body">
                                - Government ID <br>
                          ...
                          <div id="business"
                            <?php if (!$post) { echo "hidden"; } else { if ($post->category != "3") { echo "hidden"; } } ?>>
                            <div class="card card-primary">
                              <div class="card-body">
                                - Business Permit <br>
                                - Medical Certificate (C/MHO) <br>
                          ...
                          <div id="patient"
                            <?php if (!$post) { echo "hidden"; } else { if ($post->category != "4") { echo "hidden"; } } ?>>
                            <div class="card card-primary">
                              <div class="card-body">
                        ...
                        <div class="col-sm-12 col-lg-7">
                          <div class="input-group" id="frontlinerid" style="margin-bottom:10px;"
                            <?php if ($post) { if ($post->category != "1") { echo "hidden";} } ?>>
                          ...
                          <div class="input-group" id="governmentid" style="margin-bottom:10px;"
                            <?php if ($post) { if ($post->category == "3") { echo "hidden"; } } ?>>
                            <div class="custom-file">
                          ...
                          <div class="input-group" id="medicalcert" style="margin-bottom:10px;"
                            <?php if ($post) { if ($post->category == "") { echo "hidden";} } ?>>
                            <div class="custom-file">
                          ...
                          <div class="input-group" id="chestxray" style="margin-bottom:10px;"
                            <?php if ($post) { if ($post->category != "2") { echo "hidden"; } } ?>>
                            <div class="custom-file">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-4">
                  <select class="form-control" id="lgu" name="lgu" onchange="getBarangay()">
                    ...
                    <option value="<?php echo $post2->lguCode; ?>"
                      <?php if ($post) { if ($post->lgu == $post2->lguCode) { echo "selected"; } } ?>>
                ...
                <div class="col-sm-12 col-lg-4">
                  <select class="form-control" id="barangay" name="barangay">
                    <option value="<?php if ($post) { echo $post->barangay; } else { echo ""; } ?>">
                      <?php if ($post) { echo strtoupper($post->barangay); } else { echo "Select Barangay"; } ?></option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-8">
                  <input type="text" class="form-control" id="address1" name="address1" placeholder="Address"
                    value="<?php if ($post) { echo strtoupper($post->address1); } ?>">
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-4">
                  <select class="form-control" id="province" name="province" onchange="getRefCityMun()">
                    ...
                    <option value="<?php echo $post2->provCode; ?>"
                      <?php if ($post) { if ($post->province == $post2->provCode) { echo "selected"; } } ?>>
                      <?php echo strtoupper($post2->provDesc); ?></option>
                    <?php endforeach; ?>
                    <?php endif; ?>
                  </select>
                </div>
                <div class="col-sm-12 col-lg-4">
                  <select class="form-control" id="citymun" name="citymun">
                    <option value="<?php if ($post) { echo $post->citymun; } else { echo ""; } ?>">
                      <?php if ($post) { echo strtoupper($post->citymun); } else { echo "Select City / Municipal"; } ?></option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-8">
                  <input type="text" class="form-control" id="address2" name="address2" placeholder="Address"
                    value="<?php if ($post) { echo strtoupper($post->address2); } ?>">
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-3">
                  <input type="text" class="form-control" id="contactname" name="contactname" placeholder="Contact Name"
                    value="<?php if ($post) { echo strtoupper($post->contactname); } ?>">
                </div>
                <div class="col-sm-6 col-lg-2">
                  <select class="form-control" id="contactrelation" name="contactrelation">
                    <option value="">Relationship</option>
                    <option value="Husband"
                      <?php if ($post) { if ($post->contactrelation == "Husband") { echo "selected"; } } ?>>Husband
                    </option>
                    <option value="Wife"
                      <?php if ($post) { if ($post->contactrelation == "Wife") { echo "selected"; } } ?>>Wife
                    </option>
                    <option value="Father"
                      <?php if ($post) { if ($post->contactrelation == "Father") { echo "selected"; } } ?>>Father
                    </option>
                    <option value="Mother"
                      <?php if ($post) { if ($post->contactrelation == "Mother") { echo "selected"; } } ?>>Mother
                    </option>
                    <option value="Brother"
                      <?php if ($post) { if ($post->contactrelation == "Brother") { echo "selected"; } } ?>>Brother
                    </option>
                    <option value="Sister"
                      <?php if ($post) { if ($post->contactrelation == "Sister") { echo "selected"; } } ?>>Sister
                    </option>
                    <option value="Son"
                      <?php if ($post) { if ($post->contactrelation == "Son") { echo "selected"; } } ?>>Son
                    </option>
                    <option value="Daughter"
                      <?php if ($post) { if ($post->contactrelation == "Daughter") { echo "selected"; } } ?>>
                      Daughter</option>
                    <option value="Other"
                      <?php if ($post) { if ($post->contactrelation == "Other") { echo "selected"; } } ?>>Other
                    </option>
                  </select>
                </div>
                <div class="col-sm-6 col-lg-3">
                  <input type="text" class="form-control" id="contactnumber" name="contactnumber"
                    ...
                    value=<?php if ($post) { echo $post->contactnumber; } ?>>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-2">
                  <select class="form-control" id="withvehicle" name="withvehicle" onchange="enableInput()">
                    <option value="No"
                      <?php if ($post) { if ($post->withvehicle == "No") { echo "selected"; } } ?>>No</option>
                    <option value="Yes" <?php if ($post) { if ($post->withvehicle == "Yes") { echo "selected"; } } ?>>
                      Yes</option>
                  </select>
                </div>
                <div class="col-sm-6 col-lg-2">
                ...
                <div class="col-sm-6 col-lg-4">
                  <input type="text" class="form-control" id="vehicle_color_made" name="vehicle_color_made"
                    value="<?php if ($post) { echo $post->vehicle_color_made; } ?>"
